...
class _AlertsPageState extends State<AlertsPage> {
        ...
        children: [
          Row(
            children: [
              ...
              _buildSeverityBadge(alert, severityData),
            ],
          ),
          const SizedBox(height: 16),
          Text(
  ...
  Widget _buildSeverityBadge(AlertItem alert, _SeverityData severityData) {
    final String label = alert.isResolved
        ? 'Resolved'
        : severityData.label;

    final Color bgColor = alert.isResolved
        ? Colors.white.withOpacity(0.08)
        : severityData.color.withOpacity(0.12);

    final Color textColor = alert.isResolved
        ? Colors.white60
        : severityData.color;
  ...
  Widget _buildActionButton({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isPrimary ? AppColors.neonGreen : Colors.white.withOpacity(0.05),
